...
extension EarthquakesViewController: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        ...
        let normalizedMagnitude = min(max(Float(quake.magnitude), 0), 10)
        
        annotationView.displayPriority = MKFeatureDisplayPriority(lowPriority + (highPriority - lowPriority) * normalizedMagnitude / 10)
